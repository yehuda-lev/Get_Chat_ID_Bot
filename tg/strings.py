...
TEXT = {
    ...
    "ASK_AMOUNT_TO_PAY": {
        ...
        "ru": "Здравствуйте! Благодарю вас за желание внести свой вклад 🥰\n"
              "Пожалуйста, выберите сумму, которую вы хотите пожертвовать 👇",
    ...
    "PAYMENT_SUCCESS": {
        ...
        "ru": "🎉 Спасибо за ваш вклад 🎉\n" 
              "Я получил ваш взнос на сумму {} ⭐️",
